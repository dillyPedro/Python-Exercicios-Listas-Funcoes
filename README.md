...
Este repositório contém uma série de atividades desenvolvidas em Python com o objetivo de praticar conceitos intermediários e avançados da linguagem, como manipulação de coleções, funções de alta ordem, modularização e análise de dados estruturados.
...
operações matemáticas e cálculo de porcentagem formatada.
...
otimização de código com List Comprehension, 
funções de alta ordem (map), 
funções anônimas (lambda) e 
tratamento de texto com .title().
...
uso de funções nativas de agregação (max(), min(), len()) e 
manipulação dinâmica de listas.

🧠 Objetivo

Essas atividades foram desenvolvidas com foco em:
Aprofundar o conhecimento em manipulação avançada de dados, praticar a otimização de fluxos com recursos nativos do Python e desenvolver algoritmos com lógica estruturada e modular.
